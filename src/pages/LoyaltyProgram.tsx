import React from 'react';
    ...
    const LoyaltyProgram = () => {
      ...
      return (
        <MainLayout>
          {/* Hero Section */}
          <section className="relative text-white py-20 bg-cover bg-center" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1532274402911-5a369e4c4bb5?q=80&w=2560&h=1440&crop=center')` }}>
